import { RUNTIME_CONFIG } from "./runtime-config.js?v=20260825-private-data-v1";
...
export const api = {
  ...
  bootstrapKdf: () => request("/bootstrap/kdf"),
  bootstrapConfig: (siteToken) => request("/bootstrap/config", { siteToken }),
