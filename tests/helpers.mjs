...
export async function workerEnv({ siteToken = "site-test-token", adminPassword = "admin-test-password" } = {}) {
  ...
  return {
    ...
    ACCOUNT_LOOKUP_SECRET: toBase64Url(crypto.getRandomValues(new Uint8Array(48))),
    ACCOUNT_SESSION_SECRET: toBase64Url(crypto.getRandomValues(new Uint8Array(48))),
    ACCOUNT_STORAGE_SECRET: toBase64Url(crypto.getRandomValues(new Uint8Array(48))),
